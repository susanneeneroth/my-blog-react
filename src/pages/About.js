const About = () => {
    return ( 
        <div>
            ...
            <p>I am also using Git Kraken together with GitHub to be able to do backups to a repository on GitHub. I work in a dev branch until I am finished with the project. 
            </p>
